...
do
  ...
  cmd="SELECT plan_id ,count(id) as 总数, COUNT(DISTINCT(user_id)) as 发言人数 FROM xes_leave_message_log_${sub_id} WHERE 1 AND plan_id = ${plan_id} AND create_time BETWEEN '2021-10-04 00:01:01'  and '2021-10-07 23:59:59' ;"
